        ...
        <div className="relative ">
          <div className="mx-auto max-w-[1380px] ">
            <div className="grid min-h-[70vh] grid-cols-1 items-center gap-10  md:grid-cols-5 md:gap-4 ">
              {/* Text */}
              <div className="order-2 md:order-1 z-10 md:col-span-3 place-items-center px-4 sm:px-6 lg:px-8">
                <div className="space-y-6 md:space-y-3 max-w-2xl">
                  ...
                  <div>
                    ...
                    <div className="max-w-2xl text-pretty text-lg md:pr-13">
                      <TextReveal variant="blur">
                        Empowering financial institutions with cutting-edge
                        technology. Build secure, scalable, and compliant
                        banking solutions with our enterprise-grade platform.
                      </TextReveal>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    ...
                    >
                      <span className=" mr-2  text-pretty ">Explore more</span>
